...
classification.gene.entrez <- "6636"
target.gene <- "SNRPF"
```
...
plot <- grid.arrange(boxplot.target.gene.DRIVE,boxplot.target.gene.Achilles,ncol=2)

# # save plot
# plot_path <-
# "C:/Users/Martin/Documents/Master/Thesis/report/plots/boxplots/"
# ggsave(file=paste0(plot_path,"SNRPF_SNRPF_expr.svg"), plot=plot)
# ggsave(file=paste0(plot_path,"SNRPF_SNRPF_expr.png"), plot=plot)
```