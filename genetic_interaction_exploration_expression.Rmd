...
# Classification
We create two samples. One sample contains the overexpressed cell lines and the other contains the underexpressed cell lines. We summarise the samples in a classification table that shows whether a cell line is overexpressed or underexpressed. For illustration, we show the beginning of the classification table for the cell lines in the DRIVE dataset.
```{r}
...
# Comparion between highly expressing and low expressing cell lines
## Welch's t-test
...
We repeat the calculation of the p-values with the Wilcoxon ranked-sum test.
```{r eval=TRUE, fig.height=4, fig.width=10}
