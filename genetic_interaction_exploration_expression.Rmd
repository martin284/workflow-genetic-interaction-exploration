...
First, we define the input data for the workflow: the gene we use for classification into high and low expression cell lines, the sample share that determines how many cell lines are considered and the target genes to be displayed in the volcano plots.
```{r}
