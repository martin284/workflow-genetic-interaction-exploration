...
plot.welch.Achilles <- create_volcano_plot(res, "Achilles", "welch",
                                           target.genes, show_y_label = F)
...
plot.bayes.Achilles <- create_volcano_plot(res, "Achilles", "bayes",
                                           target.genes, show_y_label = F)
