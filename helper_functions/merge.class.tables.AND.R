merge.class.tables.AND <- function(class.table.gene1, class.table.gene2) {
  ...
  # remove cell lines where only one gene is mutated
  class.table.comb <- class.table.comb[!xor(class.table.comb$isDeleterious.x,
                                            class.table.comb$isDeleterious.y),]
